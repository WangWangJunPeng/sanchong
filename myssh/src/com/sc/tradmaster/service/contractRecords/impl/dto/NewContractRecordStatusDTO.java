...
public class NewContractRecordStatusDTO {
	//记录号,自动增长
	...
	//状态,0:申请,1:同意,2:删除,3:否决,4:到款,5:签约,6:退款,7:撤单
	...
	public NewContractRecordStatusDTO getNewContractRecordDTO(ContractRecords cr){
		...
		this.auditionUserId = cr.getAuditionReson();
