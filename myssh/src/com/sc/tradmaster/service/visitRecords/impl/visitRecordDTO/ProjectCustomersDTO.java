...
public class ProjectCustomersDTO {
	//案场编码
	...
	public String toString() {
		return "ProjectCustomersDTO [projectId=" + projectId + ", projectCustomerId=" + projectCustomerId
				...
				+ description + ", tags=" + tags + ", lastTime=" + lastTime + ", evaluate=" + evaluate + ", yixiang="
				+ yixiang + "]";
	}
}
