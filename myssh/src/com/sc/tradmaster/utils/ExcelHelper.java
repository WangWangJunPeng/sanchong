...
public abstract class ExcelHelper {
    ...
    protected <T> Object parseValueWithType(String value, Class<?> type) {
        ...
        try { // 根据属性的类型将内容转换成对应的类型
            if (Boolean.TYPE == type || Boolean.class.equals(type)) {
            ...
            } else if (Long.TYPE == type || Long.class.equals(type)) {
   ...
   /* public static void main(String[] args) {
        List<House> employees = new ArrayList<>();
        employees.add(new House(1000, "Jones", 40, "Manager", 2975));
        employees.add(new House(1001, "Blake", 40, "Manager", 2850));
        employees.add(new House(1002, "Clark", 40, "Manager", 2450));
        employees.add(new House(1003, "Scott", 30, "Analyst", 3000));
        employees.add(new House(1004, "King", 50, "President", 5000));
