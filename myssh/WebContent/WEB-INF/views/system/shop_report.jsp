...
<body>
	<script type="text/javascript">
		...
		function fillShopInfo(data){
			var s = "<tr><td>门店</td><td>备案数</td><td>到访确认数</td><td>备案逾期数</td><td>认购数</td><td>带客认购数</td><td>认购逾期数</td><td>签约数</td></tr>";
		...
		<div class="bill-content">
			<div class="table-list">
				<div class="form-label">
	            	...
	            	<button style="ext-decoration: none;display:inline-block;width:100px;height:33px;line-height: 30px;font-size: 15px;color:#EEEEEE;background-color:#0c95db;border-radius: 6px;margin-left: 20px; margin-top:10px" id="b2" value="0">门店报表</button>
