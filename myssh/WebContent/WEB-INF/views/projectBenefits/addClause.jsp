    ...
    <body>
        ...
        <div class="box">
            <div class="discount-clause" style="padding-bottom:4px;">
                <p style="font-size:14px;color:#0c95db;"><a href="to_pro_index" style="font-size:14px;color:#0c95db;">首页</a>&nbsp;-&nbsp;<a href="to_benefitsManage" style="font-size:14px;color:#0c95db;">价格优惠条款</a>&nbsp;-&nbsp;<a href="to_allBenefits" style="font-size:14px;color:#0c95db;">管理价格优惠条款</a>&nbsp;-&nbsp;<a href="###" style="font-size:14px;color:#0c95db;">新增价格优惠条款</a></p>
            </div>
            <div class="clause-content">
                <form action="to_insertBenefits" class="form-box" method="post" id="manageClauseVerify">
                    <div class="form-div">
