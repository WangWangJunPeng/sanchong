			...
			<div class="mui-page-content">
				<div class="mui-scroll-wrapper">
					<div class="mui-scroll">
								<div>
			<div class="top">
				<a href="to_settingSale"><img class="setting" src="static/images/APPsetting.png" alt="" /></a>
				<div class="people">
					...
					<p id="userCaption"></p>
						...
						<ul class="mui-table-view mui-table-view-chevron">
							<li class="mui-table-view-cell">
								...
								<a href="to_saleUserInfo" class="mui-navigate-right">个人资料</a>
							</li>
						</ul>
						<ul class="mui-table-view mui-table-view-chevron">
							<li class="mui-table-view-cell">
								<img src="<%=request.getContextPath()%>/static/images/14.png">
								<a href="toCustomerList" class="mui-navigate-right">我的客户 </a>
							</li>
