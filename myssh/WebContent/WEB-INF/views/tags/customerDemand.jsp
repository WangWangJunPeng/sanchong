...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="static/css/customerDemand.css" />
   

    <link  rel="icon" href="http://root-1252955170.cossh.myqcloud.com/static/static/images/titleLogo.png"  />
...
<%@ include file="publicLabelHead.jsp" %>
                ...
                <div class="row all-row">
                   <div class="col-md-8">
                    <div class="row profile-head" >
                        <p><span>*</span><a href="">首页</a>><a href="">案场信息维护</a>><a href="">标签选择</a>><a href="">客户标签</a>><a href="">客户意向</a></p>
                      <!--  <a class="aa">选择标签列表</a> -->
                        <input name="superTagType" value="${superTagType }" id="superTagType" type="hidden"/>
                    </div>
                      ...
                      <form action="" id="produceForm">
                           <div class="row  right-row " >
                               <div class="col-md-3 right-col2">
                                   <span><b style="color:#ff6161;">*</b>标签名称</span>
                               </div>
                               <div class="col-md-9">
    ...
    <script type="text/javascript" src="static/js/customerDemand.js"></script>
