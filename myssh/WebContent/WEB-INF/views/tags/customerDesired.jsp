...
<%@ include file="publicLabelHead.jsp" %>
                ...
                <div class="row all-row">
                   <div class="col-md-8">
                    <div class="row profile-head" >
                        <p><span>*</span><a href="">首页</a>><a href="">案场信息维护</a>><a href="">标签选择</a>><a href="">客户标签</a>><a href="">客户需求</a></p>
                       <a class="aa">新建标签列表</a>
    ...
    <script type="text/javascript" src="static/js/customerDesired.js"></script>
