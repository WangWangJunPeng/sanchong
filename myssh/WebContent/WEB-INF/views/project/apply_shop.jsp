    ...
    <%@include file="/WEB-INF/views/system/public/systempublicpage.jsp" %>
        <div class="box">
            ...
            <div class="form-label">
            	...
            	<button style="ext-decoration: none;display:inline-block;width:150px;height:30px;line-height: 30px;font-size: 15px;color:#EEEEEE;background-color:#169bd5;border-radius: 6px;margin-left: 20px;" id="b2" value="0">只显示审核中的申请</button>
