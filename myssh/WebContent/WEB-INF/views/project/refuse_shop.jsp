    ...
    <%@include file="/WEB-INF/views/system/public/systempublicpage.jsp" %>
        <div class="box">
            ...
            <div class="form-label">
            	...
            	<button style="ext-decoration: none;display:inline-block;width:165px;height:30px;line-height: 30px;font-size: 15px;color:#666666;background-color:#e0e0e0;border-radius: 6px;margin-left: 20px;" id="b3"  value="1">只显示审核通过的申请</button>
            	<button style="ext-decoration: none;display:inline-block;width:135px;height:30px;line-height: 30px;font-size: 15px;color:#EEEEEE;background-color:#169bd5;border-radius: 6px;margin-left: 20px;" id="b4"  value="3">只显示拒绝的申请</button>
            </div>
